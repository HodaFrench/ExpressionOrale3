...
const MOTIFS = [
  ...
  ['constituer un obstacle', /constitu(e|ent|er|ait)\s+(souvent\s+)?un\s+obstacle/],
  ...
  ['dépendre de',         /dépend(e|ent|re)?\s+(pas\s+)?(de|surtout|d[e’'])/],
  ['se révéler',          /se\s+révél|s[’']avér/],
  ['risquer de',          /risqu(e|ent|er)\s+de/],
